...
class PersonalDataForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        PersonalDataField(label: "No .Telepon", value: controller.noTelp.value),
        PersonalDataField(label: "Alamat Email", value: controller.email.value),
      ],
    );
  }
}
